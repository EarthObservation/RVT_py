...
rendered_image = rvt.vis.multi_scale_topographic_position(
    dem=dem_arr, no_data=dem_nodata
)
...
rvt.default.save_raster(
    ...
    out_raster_path=output_mstp_path_8bit,
    out_raster_arr=image_8bit,
    no_data=np.nan,
    e_type=1,
)  # e_type has to be 1 because visualization is 8-bit (0-255)
