...
Source: Orengo, H. A., and Petrie, C. A. (2018) Multi-scale relief model (MSRM): a new algorithm for the visualization of subtle topographic change of variable size in digital elevation models. `Earth Surface Processes and Landforms, 43: 1361–1369 <https://onlinelibrary.wiley.com/doi/full/10.1002/esp.4317>`_
