...
slope_arr_norm = np.interp(slope_arr, (np.nanmin(slope_arr), np.nanmax(slope_arr)), (0, 1))  # normalize (0-1)
# more colors: https://matplotlib.org/3.3.2/tutorials/colors/colormaps.html
slope_arr_rgba = rvt.blend.gray_scale_to_color_ramp(gray_scale=slope_arr_norm, colormap="BuGn")  # compute color scheme
...
output_slope_dataset.colorinterp = [ColorInterp.red, ColorInterp.green, ColorInterp.blue, ColorInterp.alpha]
