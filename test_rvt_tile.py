...
def test_rvt_slope_tile_by_tile() -> None:
    ...
    slope_float_tile_by_tile_arr = rvt.default.get_raster_arr(out_slope_float_path.as_posix())["array"]
    slope_8bit_tile_by_tile_arr = rvt.default.get_raster_arr(out_slope_8bit_path.as_posix())["array"]
    ...
    slope_8bit_arr = default_values.float_to_8bit(float_arr=slope_arr, visualization=rvt.default.RVTVisualization.SLOPE)
...
def test_rvt_hillshade_tile_by_tile() -> None:
    ...
    hillshade_float_tile_by_tile_arr = rvt.default.get_raster_arr(out_hillshade_float_path.as_posix())["array"]
    hillshade_8bit_tile_by_tile_arr = rvt.default.get_raster_arr(out_hillshade_8bit_path.as_posix())["array"]
    dem_arr_dict = rvt.default.get_raster_arr(dem_path.as_posix())
    ...
    assert np.array_equal(hillshade_float_tile_by_tile_arr, hillshade_arr, equal_nan=True)
    assert np.array_equal(hillshade_8bit_tile_by_tile_arr, hillshade_8bit_arr, equal_nan=True)
...
def test_rvt_svf_tile_by_tile() -> None:
    ...
    svf_float_tile_by_tile_arr = rvt.default.get_raster_arr(out_svf_float_path.as_posix())["array"]
    svf_8bit_tile_by_tile_arr = rvt.default.get_raster_arr(out_svf_8bit_path.as_posix())["array"]
    dem_arr_dict = rvt.default.get_raster_arr(dem_path.as_posix())
...
def test_rvt_multi_hillshade_tile_by_tile() -> None:
    ...
    mhs_float_tile_by_tile_arr = rvt.default.get_raster_arr(out_mhs_float_path.as_posix())["array"]
    mhs_8bit_tile_by_tile_arr = rvt.default.get_raster_arr(out_mhs_8bit_path.as_posix())["array"]
    dem_arr_dict = rvt.default.get_raster_arr(dem_path.as_posix())
